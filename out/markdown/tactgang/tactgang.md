...
Danil: AI (reply to 963)

Пескарь™ | фронтент телефонов: это обратная перемотка видео времени вроде

Mark: А как у тебя обсервабилити сделано, где ты смотришь, как агенты работают и че делают (reply to 888)

Mark: Я решил попробовать формат супергруппа на одну задачу, и в супергруппе боты общаются через новую фичу Bot to Bot + html dashboard со всеми задачами и просмотром статусов в md + ещё отдельный бот, который в личке со мной может создавать задачи, спрашивать у менеджеров задач как их дела итд (reply to 968)

Пескарь™ | фронтент телефонов: чзхн (reply to 970)

Пескарь™ | фронтент телефонов: а почему не топики типо

Mark: Топики ебаная залупа (reply to 972)

Пескарь™ | фронтент телефонов: почему

Mark: Лагучее говно, UX отвратный, баги в API

Mark: У тебя нет чувства прекрасного (reply to 974)

Пескарь™ | фронтент телефонов: ну если там лютый поток сообщений, то лагучее говно, это правда

Пескарь™ | фронтент телефонов: UX хз ну типо ну как бы норм

Пескарь™ | фронтент телефонов: а то что API хуйня это чистейшая правда не буду спорить

Пескарь™ | фронтент телефонов: прост хз на каждую задачу по группе типа эмм

Mark: Бототопики пробовал though в предыдущей версии своего решения. Они тоже не очень.  Я сделал анимированный эмодзи пак со статусами 💭✅❌❔, у меня была идея чтобы бот ставил эти эмодзи как иконки топиков, чтобы быстро ориентироваться по статусу, но Левин решил что так нельзя и такое поддерживаться не будет, депни 5к тон за премиум бота пожалуйста

Mark: Ну я отдельный тг акк под это выделил чисто для задач (reply to 980)

Пескарь™ | фронтент телефонов: тысяча тон цена теперь кст (reply to 981)

Пескарь™ | фронтент телефонов: можно подумать

Mark: Я за тысячу тон куплю 3 подписки на Codex и 3 подписки на Claude за 200 баксов и напишу свой телеграм лол (reply to 983)

Пескарь™ | фронтент телефонов: жппграм есть

Mark: Я пока не настолько богатый депать 1к тон на эксперимент

Пескарь™ | фронтент телефонов: ну пока что нету (reply to 986)

Пескарь™ | фронтент телефонов: но будет

— 2026-05-21 —

Skuli: В терминалах https://t.me/ProverCoderAI/40?single  У меня в системе подписку Клод код юзать можно (reply to 968)

Skuli: У меня вся работа идёт через гитхаб (reply to 970)

Skuli: У меня моя система способа из коробки разрабатывать TG ботов, TMA, Defi   В плане сама разрабатывать и тестировать   Создавать в бот фазере ключи для ТГ ботов   Делать e2e может все

Skuli: Дорабатываю кое какой UX и взаимодействие и дропну TonAI v2   Сможет из коробки делать смарт контакты, TMA, tg bots, defi apps

Mark: Дискуссии агентов в гитхабе ты имеешь в виду? (reply to 991)

Mark: За bun кстати респект

Skuli: Моя система не про агентов  А про окружение для агентов  Я не пытаюсь конкурировать с Codex/ClaudeCode а даю систему где эти агенты могут давать иксы по перфомансу (reply to 994)

Skuli: Да (reply to 995)

Skuli: У меня суть проекта что вся работа ведётся в докерах  Изолированные среды   И у агентов 100% права

Skuli: + удобные макросы разные

Skuli: И прозрачность системы

Mark: Это понятно (reply to 997)

Mark: Ну вот у меня например к каждому проекту привязан агент-разработчик, ревьювер и менеджер. У всех них разные MCP, указания и промпты. Они между собой общаются. Флоу примерно такой: менеджер дает задачу, контролирует выполнение, требует e2e тестирование. Когда примерно готово, просит у ревьювера сделать ревью. Потом например разработчик может попросить дать ему тестовый TON кошелек с небольшим балансом, чтобы протестить фичу в Playwright. Менеджер может это сделать.  А у тебя как?

Skuli: Мой пай плайн такой: Я пишу Issues на гитхаб  потом docker-git clone github.com/issues/10 --mcp-playright У меня создаётся изолированный контейнер с проектом и моим агентом  Я пишу codex потом /plan и говорю что бы он составил для моего issues план   Он составляет план и после начинает работать У него есть доступ к моему гитхабу, полнтый доступ к контейнеру, допступ к браузеру (которым я так же могу управлять)  Я не очень люблю MCP потому что агентские системы он зачастую убивает и даже бы ушёл от использования MCP в Playright, но пока мне лень этим заниматься   Я пока не использую ни скилы особо, ничего такого  Я строю систему, окружение где агенты могут работать полностью автономно и изолировано и я буду иметь прозрачную систему  Так же у меня есть Review PR (rabbitcoder ревьюит мои RP) (reply to 1003)

Skuli: Я могу паралельно решать по 6+ задач Зависит от задач Могу и по 10 смотря какие

— 2026-08-11 —

Пескарь™ | фронтент телефонов: https://t.me/postypashki_old/1841

Пескарь™ | фронтент телефонов: ты ахуел (reply to 1013)

Пескарь™ | фронтент телефонов: О ПРИВЕТ

Maksim: мемы реально крутые слишком отвлекают от работы

Пескарь™ | фронтент телефонов: блять

sepezho: хорошие мемы

max: Тамада развлекает

max: Шедевр (reply to 1010)
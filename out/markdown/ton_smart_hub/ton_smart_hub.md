...
K: In problem c i test the throw error when a voter votes twice, searching for a transaction to the contract "Proposal" and with that error exit code, is that the correct way to test it ?
...
K: And for A as well, check the first submission of markelaft (reply to 2485)
...
K: hint on that jump from 14/15? (reply to 2752)
...
K: Check in the docs how the deployment works (reply to 2766)

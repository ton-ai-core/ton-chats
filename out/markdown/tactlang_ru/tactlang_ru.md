...
Boris: Здравствуйте, вопрос от новичка, у меня включён в компиляции файла дебаг и я использую функцию dump для вывода ошибки через try...catch, как можно посмотреть саму ошибку, нужно её как-то через tonviewer testnet смотреть?

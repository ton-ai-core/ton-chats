...
sayhelloandrey: ну ты видимо локально внутри сессии хранишь данные и никак их не фильтруешь в зависимости от юзера (reply to 304874)

sayhelloandrey: подключи бд
...
proset24541: немного не туда обратился (reply to 305049)

Combot: Combot выдал(а) предупреждение Surm (1/3) Reason: 1 reports (reply to 305061)

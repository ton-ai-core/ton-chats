...
D: Знаю что можно, но не знаю как😁 (reply to 285645)
...
D: It is Russia speaking chat. @tondev_eng (reply to 285706)
...
D: Здравствуйте. Можно вопрос, а что, разве Ton Connect только для веб приложений?)

Tim: не только (reply to 286473)

D: Спасибо! (reply to 286474)
...
D: Не разводите Флуд (reply to 286488)
...
D: Это Вам в чат ТМА Build (reply to 286753)
...
Илья: Ну в офф доков практически все расписано, какие-то моменты можно у deepseek к примеру уточнать, но она иногда врет.
...
1/2: рекординг ин блокчейн уже больше часа длится это норма?
...
1/2: а на фрагменте же транзакции проходят через блокчейн тона? я просто не особо разбираюсь, извините (reply to 287259)
...
Илья: FunC до последнего вздоха
...
ᅠwhyousmile: Привет ребят, кто в смарт контрактах шарит? нужен разраб под проект
...
wlaDICK v.2: А какую юзерку угнали ? (reply to 290362)
...
pluшak: Привет всем, ребят, а у тона есть публичные сервера как у того же xrp ledger для девелопмента?
...
@sowlc: коллеги, подкиньте бота который тестнеты раздавал

Max: @testgiver_ton_bot (reply to 292270)

@sowlc: благодарю (reply to 292271)
...
Илья: https://docs.ston.fi/docs/developer-section/sdk/dex-v2/swap что-то такое? (reply to 292437)

...
Всеволод Игнатьев: Ищу работу тимлидом/техлидом или блокчейн-разработчиком.
...
Всеволод Игнатьев: https://docs.ton.org/v3/documentation/network/configs/blockchain-configs#param-15 (reply to 285631)

...
D: Доброй ночи. Есть чатб Jobs, спросите там) (reply to 260168)

Григорий Н.: Если дадите ссылку на него, буду благодарен. (reply to 260169)

D: Сюда нельзя(. Зайди на офф.сайт тон, там она должна быть. Раздел сверху, для разработчиков вроде😉 (reply to 260170)
...
User<1689334976>: Какие операции занимают наибольшее количество газа? (reply to 262831)
...
User<1689334976>: Да, видимо пробовать процесс удаления разбивать
...
TONUR?!: напишите лч, кто linux шпарит
...
ㅤㅤㅤ: мне кажется или там снизу написано что "приложение не может переводить средства без вашего разрешения"? (reply to 272673)
...
ㅤㅤㅤ: нуу наверное тебе нужно знать Язык программирования и иметь Visual Studio, хотя можно и в Гитхаб🤷‍♂ (reply to 272805)
...
ㅤㅤㅤ: верим в тебя 💪 (reply to 272834)
...
@sowlc: подскажите пожалуйста, Как-то можно получать через API HTTP GET инфу о совершенной транзакции?
...
@sowlc: всем огромное спасибо за помощь!

Namon: Claude минимум с конца сентября знает доку по тону и func

@sowlc: можешь дать пожалуйста полную ссылку для апи? 😅 (reply to 273151)

@sowlc: я про вот эту)  не понимаю к какому домену ее относить (reply to 273151)
...
ㅤㅤㅤ: великие слова 👏👏 (reply to 273170)
...
ㅤㅤㅤ: Правила чата TON Dev Chat (РУ)
